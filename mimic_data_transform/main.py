...
##%% filter only the row with cxr_view with AP or PA

# file_path = "/Users/maxxyouu/Desktop/CT-CLIP/dataset/multi_abnormality_labels/mimic_ct_report_paired_with_ordered_label.csv"  # Replace with your actual file path
# df = pd.read_csv(file_path)

# # Filter rows where cxr_view is either 'PA' or 'AP'
# filtered_df = df[df['cxr_view'].isin(['PA', 'AP'])]

# # Save the filtered data back to a new CSV file
# filtered_file_path = "/Users/maxxyouu/Desktop/CT-CLIP/dataset/multi_abnormality_labels/mimic_ct_report_paired_with_ordered_label_pa_ap.csv"  # Replace with desired output file name
...
output_csv_path = '/Users/maxxyouu/Desktop/CT-CLIP/dataset/multi_abnormality_labels/mimic_ct_report_paired_with_ordered_label_pa_ap.csv'
...
input_csv_path = '/Users/maxxyouu/Desktop/CT-CLIP/dataset/multi_abnormality_labels/mimic_ct_report_paired_with_ordered_label_pa_ap.csv'
