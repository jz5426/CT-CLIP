...
def run(cfg):
    ...
    trainer = CTClipTrainer(
        clip_xray,
        cfg=cfg,
        reports_file_train= "C:\\Users\\MaxYo\\OneDrive\\Desktop\\MBP\\chris\\CT-CLIP\\dataset\\radiology_text_reports\\valid_reports.csv",
        reports_file_valid= "C:\\Users\\MaxYo\\OneDrive\\Desktop\\MBP\\chris\\CT-CLIP\\dataset\\radiology_text_reports\\valid_reports.csv",
