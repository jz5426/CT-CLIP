...
## longer run
python /cluster/home/t135419uhn/CT-CLIP/scripts/run_train.py training_params.batch_style=experiment training_params.training_pretrain_baseline=cxr_clip_swin training_params.epochs=202 training_params.min_epochs=200 training_params.use_pretrained_xray_encoder=false training_params.loss_function=siamese training_params.projector_type=infoNCE
python /cluster/home/t135419uhn/CT-CLIP/scripts/run_train.py training_params.batch_style=experiment training_params.training_pretrain_baseline=cxr_clip_resnet training_params.epochs=202 training_params.min_epochs=200 training_params.use_pretrained_xray_encoder=false training_params.loss_function=siamese training_params.projector_type=infoNCE
